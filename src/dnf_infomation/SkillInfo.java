...
public class SkillInfo {
	...
	public static Object[] skillInfo_fighter()
	{
		Object[] data = new Object[] {
				...
				"사자후", Skill_type.ACTIVE, Job.NENMASTER_F, 35, 60, 50, 2, Element_type.NONE, CalculatorVersion.VER_1_2_b,
				...
				"26 0 0 2480*7 0", "+ 2207*7", "+ 22660*7", "+ 23242*7", "+ 23824*7", "+ 24406*7", null, 
				"광충노도", Skill_type.ACTIVE , "", 45, 60, 50, 2, Element_type.LIGHT, CalculatorVersion.VER_1_2_b, "설명 광충풀히트기준 추측치. 오퍼레이션 히트분석급 논문 존재시 첨부 부탁",
				"24 0 0 0 489.05*1.5", "+ 504.38*1.5", "+ 519.31*1.5", "+ 553.64*1.5", "+ 548.76*1.5", "+ 564.10*1.5", "+ 579.03*1.5", null, 
				"광충 즉폭", Skill_type.OPTION, "", 85, 1, 1, 1, Element_type.NONE, CalculatorVersion.VER_1_2_b, "설명 무기속성 따라가라고 무속 적용", "설명 완충데미지는 옵션키세요 완충노충 사이 퍼뎀은 몰라서 생략",				
				...
				"13 0 0 3425*6+13669 0", "+ 3753*6+15012", "+ 3917*6+15669", "+ 4082*6+16326", "+ 4245*6+16982", "+ 4410*6+17639", "+ 4574*6+18296", null, 
				"태사자후", "", "", 70, 40, 30, 2,  Element_type.LIGHT, CalculatorVersion.VER_1_2_b, "설명 명속성 추가 데미지 포함",
				"10 0 0 11540+1080*2 115.4+10.8*2", "+ 12152+1160*2 121.52+11.6*2", "+ 12765+1240*2 127.65+12.4*2", 
				"+ 13376+1310*2 133.76+13.1*2", "+ 13988+1390*2 139.88+13.9*2", "+ 14600+1470*2 146+14.7*2",
				"16 15212+1550*2 152.12+15.5*2", "17 15824+1630*2 158.24+16.3*2",null, 
				"세인트 일루전", "", "", 75, 40, 30, 2,  Element_type.LIGHT, CalculatorVersion.VER_1_2_b,
				...
				"광휘의 넨", Skill_type.ACTIVE, "", 85, 40, 30, 5, Element_type.NONE, CalculatorVersion.VER_1_2_b, 
				"3 0 0 120952*116.5 0", "+ 140113*116.5", "+ 159274*116.5", "+ 178434*116.5", "+ 197595*116.5", "+ 216756*116.5", null, //노충기준 풀충옵션

				//////패시브
				"분신", Skill_type.PASSIVE, Job.NENMASTER_F, 5, 20, 10, 2, CalculatorVersion.VER_1_2_b,
				"10","스킬 환영폭쇄 % 1500", "+", "스킬 환영폭쇄 % +100", "반복 1",
				"축기", Skill_type.PASSIVE, "", 75, 40, 30, 3, CalculatorVersion.VER_1_2_b,
				"7", "스킬 기공장 % 45 & 스킬 사자후 % 45 & 스킬 태사자후 % 45 & 스킬 세인트 일루전 % 45 & 스킬 흡기공탄 % 45 & 스킬 광휘의넨 % 45 & 스킬 광충노도 % 30", 
				"+", "스킬 기공장 % +3 & 스킬 사자후 % +3 & 스킬 태사자후 % +3 & 스킬 세인트 일루전 % +3 & 스킬 흡기공탄 % +3 & 스킬 광휘의넨 % +3 & 스킬 광충노도 % +0",
				"반복 1",
				...
				"기공장 강화", "기공장", "", 65, 7, 5, 100/7, CalculatorVersion.VER_1_2_b, null,
	...
	public static Object[] skillInfo_demonicLancer()
	{
		Object[] data = new Object[] {
				...
				"15", "스킬 스월링 스피어 % 35 & 스킬 그라운드 씨커 % 35 & 스킬 라이징 랜서 % 35 & 스킬 트윈 펀토 % 35 & 스킬 슈트롬 % 34 & 스킬 파동연환창 % 34 & 스킬 공아 % 34 & 스킬 메조싸이클론 % 34 & 스킬 뇌격점혈섬 % 34 & 스킬 오러 포스 재블린 % 34 & 스킬 롤링벌컨 % 34 & 스킬 삼일참월 % 34 & 스킬 쿼드러플 드라이브 % 34 & 스킬 미스트 플레어 % 34 & 스킬 살극쌍연무 % 34",
				...
				"메조사이클론 강화", "메조사이클론", "", 65, 7, 5, 10, CalculatorVersion.VER_1_2_b, null, 
