...
public class EquipInfo_fabric {
	public static void getInfo(HashSet<Equipment> equipList)
	{
		...
		level=80;
		//닼고상의
		temp = new Equipment("다크 고스 상의", null, Item_rarity.EPIC, Equip_part.ROBE, type, SetName.DARKGOTH, level);
		...
		//닼고하의
		temp = new Equipment("다크 고스 하의", null, Item_rarity.EPIC, Equip_part.TROUSER, type, SetName.DARKGOTH, level);
		temp.vStat.addStatList("지능", new StatusInfo(48), true);
		// TODO 60Lv 2
		temp.dStat.addStatList("암", new ElementInfo(30), true);
		...
		//닼고숄더
		temp = new Equipment("다크 고스 숄더", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, SetName.DARKGOTH, level);
		...
		//닼고벨트
		temp = new Equipment("다크 고스 벨트", null, Item_rarity.EPIC, Equip_part.BELT, type, SetName.DARKGOTH, level);
		...
		//닼고신발
		temp = new Equipment("다크 고스 샌들", null, Item_rarity.EPIC, Equip_part.SHOES, type, SetName.DARKGOTH, level);
		temp.vStat.addStatList("지능", new StatusInfo(29), true);
		temp.dStat.addStatList("암", new ElementInfo(30), true);
		equipList.add(temp);
		...
		level=85;
		//불마상의, 마나번
		temp = new Equipment("마나 번 로브", null, Item_rarity.EPIC, Equip_part.ROBE, type, SetName.BURNINGSPELL, level);
		...
		//불마하의
		temp = new Equipment("매직 번 트라우저", null, Item_rarity.EPIC, Equip_part.TROUSER, type, SetName.BURNINGSPELL, level);
		temp.vStat.addStatList("지능", new StatusInfo(48), true);
		temp.dStat.addStatList("크증뎀", new StatusInfo(15), false, true);
		equipList.add(temp);
		
		//불마어깨, 스펠번
		temp = new Equipment("스펠 번 숄더 패드", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, SetName.BURNINGSPELL, level);
		...
		//불마벨트
		temp = new Equipment("엘리멘탈 번 새쉬", null, Item_rarity.EPIC, Equip_part.BELT, type, SetName.BURNINGSPELL, level);
		temp.vStat.addStatList("지능", new StatusInfo(31), true);
		temp.dStat.addStatList("마크", new DoubleStatusInfo(20), false, true);
		equipList.add(temp);
		
		//불마신발, 소울번
		temp = new Equipment("소울 번 슈즈", null, Item_rarity.EPIC, Equip_part.SHOES, type, SetName.BURNINGSPELL, level);
		temp.vStat.addStatList("지능", new StatusInfo(31), true);
		...
		/////드로퍼
		//프컷로브
		temp = new Equipment("프리징 컷 로브", null, Item_rarity.EPIC, Equip_part.ROBE, type, SetName.DROPPER, level);
		temp.vStat.addStatList("지능", new StatusInfo(51), true);
		...
		//플드랍
		temp = new Equipment("플레임 드랍 트라우저", null, Item_rarity.EPIC, Equip_part.TROUSER, type, SetName.DROPPER, level);
		temp.vStat.addStatList("지능", new StatusInfo(51), true);
		...
		//레디숄, 레이숄
		temp = new Equipment("레이 디크리즈 숄더", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, SetName.DROPPER, level);
		...
		//닼로새쉬
		temp = new Equipment("다크니스 로우 새쉬", null, Item_rarity.EPIC, Equip_part.BELT, type, SetName.DROPPER, level);
		...
		//페다슈, 페이스다운
		temp = new Equipment("페이스 다운 슈즈", null, Item_rarity.EPIC, Equip_part.SHOES, type, SetName.DROPPER, level);
		temp.vStat.addStatList("지능", new StatusInfo(75), true);
