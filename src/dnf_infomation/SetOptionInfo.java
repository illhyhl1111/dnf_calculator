...
public class SetOptionInfo {
	public static void getInfo(LinkedList<SetOption> setOptionList)
	{
		...
		/////천
		//닼고
		temp = new SetOption(SetName.DARKGOTH, 5);
		...
		setOptionList.add(temp);
		//오기일
		temp = new SetOption(SetName.OGGEILL, 3);
		...
		setOptionList.add(temp);
		temp = new SetOption(SetName.OGGEILL, 5);
		...
		setOptionList.add(temp);
		//게슈펜슈트
		temp = new SetOption(SetName.GESPENST, 5);
		temp.explanation.add("미구현");
		setOptionList.add(temp);

		/////가죽
		//카멜
		temp = new SetOption(SetName.CHAMELEON, 5);
		...
		setOptionList.add(temp);
		//암살
		temp = new SetOption(SetName.ASSASSIN, 5);
		...
		setOptionList.add(temp);
		//핀드
		temp = new SetOption(SetName.FIENDVENATOR, 5);
		temp.explanation.add("미구현");
		setOptionList.add(temp);
		
		/////경갑
		//섭마
		temp = new SetOption(SetName.SUBMARINE, 5);
		temp.vStat.addStatList("화속", 50);
		temp.vStat.addStatList("화추뎀", 8);
		setOptionList.add(temp);
		//자수
		temp = new SetOption(SetName.NATURALGARDIAN, 5);
		...
		setOptionList.add(temp);
		//아이실드
		temp = new SetOption(SetName.EYESHIELD, 5);
		...
		setOptionList.add(temp);
		//황갑
		temp = new SetOption(SetName.GOLDENARMOR, 3);
		temp.vStat.addStatList("모속강", 25);
		temp.vStat.addStatList("추뎀", 15);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GOLDENARMOR, 5);
		temp.vStat.addStatList("크증뎀", 35);
		setOptionList.add(temp);
		//초대륙
		temp = new SetOption(SetName.SUPERCONTINENT, 5);
		temp.explanation.add("미구현");
		setOptionList.add(temp);
		
		/////중갑
		temp = new SetOption(SetName.SPIDERQUEEN, 4);
		...
		temp = new SetOption(SetName.SPIDERQUEEN, 5);
		...
		setOptionList.add(temp);
		//금계
		temp = new SetOption(SetName.FORBIDDENCONTRACT, 5);
		...
		/////판금
		//인피니티
		temp = new SetOption(SetName.INFINITY, 5);
		...
		setOptionList.add(temp);
		//마소
		temp = new SetOption(SetName.MAELSTORM, 5);
		...
		setOptionList.add(temp);
		//풀플
		temp = new SetOption(SetName.FULLPLATE, 5);
		...
		/////////////악세서리
		//슈스
		temp = new SetOption(SetName.SUPERSTAR, 3);
		temp.vStat.addStatList("추뎀", 15);
		temp.dStat.addStatList("추뎀", 10, false, true);
		setOptionList.add(temp);
		//얼공
		temp = new SetOption(SetName.ICEQUEEN, 3);
		temp.vStat.addStatList("수속강", 50);
		temp.vStat.addStatList("추뎀", 18);
		setOptionList.add(temp);
		//정마
		temp = new SetOption(SetName.REFINEDSTONE, 3);
		...
		setOptionList.add(temp);
		//하늘의 여행자
		temp = new SetOption(SetName.SKYTRAVELER, 3);
		temp.vStat.addStatList("추뎀", 30);
		setOptionList.add(temp);
		//황홀경
		temp = new SetOption(SetName.ECSTATICSENCE, 3);
		...
		//////////////레전더리
		///////결장
		temp = new SetOption(SetName.REAL_PROFIGHTER_ACCESSORY, 3);
		temp.dStat.addStatList("크증뎀", 15, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_SPECIALEQUIP, 2);
		temp.vStat.addStatList("독공", 165);
		temp.vStat.addStatList("모속강", 18);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_FABRIC, 5);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_HARMOR, 5);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_LEATHER, 5);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_MAIL, 5);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_PLATE, 5);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.GODOFFIGHT, 3);
		temp.vStat.addStatList("물크", 3);
		temp.vStat.addStatList("마크", 3);
		temp.vStat.addStatList("크증뎀", 15);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GODOFFIGHT, 5);
		temp.dStat.addStatList("힘뻥", 5, false, true);
		temp.dStat.addStatList("지능뻥", 5, false, true);
		temp.vStat.addStatList("증뎀", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GODOFFIGHT, 6);
		...
		/////////////퀘전더리
		//위영
		temp = new SetOption(SetName.GREATGLORY, 3);
		temp.dStat.addStatList("힘", 100, false);
		temp.dStat.addStatList("지능", 100, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GREATGLORY, 5);
		temp.dStat.addStatList("힘뻥", 5);
		temp.dStat.addStatList("지능뻥", 3);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GREATGLORY, 6);
		temp.dStat.addStatList("힘뻥", 3);
		temp.dStat.addStatList("지능뻥", 3);
		setOptionList.add(temp);
		//비탄
		temp = new SetOption(SetName.DEVASTEDGRIEF, 3);
		temp.dStat.addStatList("증뎀", 20, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.DEVASTEDGRIEF, 5);
		temp.vStat.addStatList("모속강", 15);
		temp.explanation.add("증뎀옵션은 3셋옵션을 키세여");
		setOptionList.add(temp);
		temp = new SetOption(SetName.DEVASTEDGRIEF, 6);
		temp.explanation.add("슈아쳐가 됩니다");
		setOptionList.add(temp);
		//그라시아
		temp = new SetOption(SetName.GRACIA, 3);
		temp.vStat.addStatList("힘", 50);
		temp.vStat.addStatList("힘", 50);
		temp.vStat.addStatList("명속강", 10);
		temp.dStat.addStatList(Element_type.LIGHT, 0, true, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GRACIA, 5);
		temp.vStat.addStatList("명속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GRACIA, 6);
		temp.vStat.addStatList("명추뎀", 6);
		setOptionList.add(temp);
		//비명
		temp = new SetOption(SetName.BURIEDSCREAM, 3);
		temp.vStat.addStatList("모속강", 10);
		temp.dStat.addStatList("%물방깍_템", 10, false, true);
		temp.dStat.addStatList("%마방깍_템", 10, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.BURIEDSCREAM, 5);
		temp.vStat.addStatList("모속강", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.BURIEDSCREAM, 6);
		temp.dStat.addStatList("고정물방깍", 12000, false, true);
		temp.dStat.addStatList("고정마방깍", 12000, false, true);
		setOptionList.add(temp);
		//해신
		temp = new SetOption(SetName.CURSEOFSEAGOD, 3);
		temp.vStat.addStatList("힘", 70);
		temp.vStat.addStatList("지능", 70);
		temp.dStat.addStatList(Element_type.WATER, 0, true, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.CURSEOFSEAGOD, 5);
		temp.dStat.addStatList("추뎀", 20, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.CURSEOFSEAGOD, 6);
		temp.explanation.add("저주쳐가 됩니다");
		setOptionList.add(temp);
		//질병
		temp = new SetOption(SetName.ROOTOFDISEASE, 3);
		temp.dStat.addStatList("%물방깍_템", 10, false, true);
		temp.dStat.addStatList("%마방깍_템", 10, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.ROOTOFDISEASE, 5);
		...
		setOptionList.add(temp);
		temp = new SetOption(SetName.ROOTOFDISEASE, 6);
		temp.explanation.add("절레");
		setOptionList.add(temp);
		//로맨티스트
		temp = new SetOption(SetName.ROMANTICE, 3);
		temp.dStat.addStatList("추뎀", 8, false, true);
		temp.explanation.add("추뎀 조건 : 인간형");
		setOptionList.add(temp);
		temp = new SetOption(SetName.ROMANTICE, 5);
		...
		setOptionList.add(temp);
		//길던
		temp = new SetOption(SetName.GUILDACCESSORY_FIRE, 3);
		temp.dStat.addStatList("화속강", 10);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GUILDACCESSORY_WATER, 3);
		temp.dStat.addStatList("수속강", 10);
		setOptionList.add(temp);
		
		/////////////아바타
		//레압
		temp = new SetOption(SetName.RAREAVATAR, 3);
		temp.vStat.addStatList("힘", new StatusInfo(20));
		temp.vStat.addStatList("지능", new StatusInfo(20));
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.RAREAVATAR, 5);
		temp.explanation.add("데미지 증가 효과 없음");
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.RAREAVATAR, 8);
		temp.vStat.addStatList("힘", new StatusInfo(20));
		temp.vStat.addStatList("지능", new StatusInfo(20));
		setOptionList.add(temp);
		
		//상압
		temp = new SetOption(SetName.AVATAR, 3);
		temp.vStat.addStatList("힘", new StatusInfo(10));
		temp.vStat.addStatList("지능", new StatusInfo(10));
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.AVATAR, 5);
		temp.explanation.add("데미지 증가 효과 없음");
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.AVATAR, 8);
		temp.vStat.addStatList("힘", new StatusInfo(10));
		temp.vStat.addStatList("지능", new StatusInfo(10));
		setOptionList.add(temp);
	}
