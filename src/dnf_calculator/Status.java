													...
													// 솔직히 번호붙은게 개판이라 다시 정리해야함
{
	...
	int DEF_DEC_FIXED_PHY=8; int  DEF_DEC_PERCENT_PHY_ITEM=9; int DEF_DEC_FIXED_MAG=36; int DEF_DEC_PERCENT_MAG_ITEM=37;	// 고정물방깍, 퍼센트물방깍, 고정마방깍, 퍼센트마방깍
	...
	int DEF_DEC_PERCENT_PHY_SKILL=45; int DEF_DEC_PERCENT_MAG_SKILL=46;												//(스킬) 퍼센트물방깍, 퍼센트마방깍
	int ELEM_FIRE_DEC=47; int ELEM_WATER_DEC=48; int ELEM_LIGHT_DEC=49; int ELEM_DARKNESS_DEC=50;					// 화속저, 수속저, 명속저, 암속저
	
	public static final int STATNUM = 51;							// 총 스탯 개수
