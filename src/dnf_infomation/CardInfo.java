...
public class CardInfo {
	public static void getInfo(LinkedList<Card> cardList)
	{
		...
		//아그네스
		temp = new Card("찬란한 불꽃의 아그네스 보주", rarity);
		...
		//쿠로
		temp = new Card("강완의 쿠로 보주", rarity);
		temp.addPart(Equip_part.ROBE);
		temp.vStat.addStatList("힘", new StatusInfo(65));
		cardList.add(temp);
		
		//로크
		temp = new Card("흑화의 로크 보주", rarity);
		temp.addPart(Equip_part.WEAPON);
		temp.addPart(Equip_part.ROBE);
		temp.addPart(Equip_part.TROUSER);
		...
		//노블보주
		temp = new Card("노블스카이 황옥 보주", rarity);
		...
		temp = new Card("노블스카이 녹옥 보주", rarity);
		temp.addPart(Equip_part.SHOULDER);
		temp.addPart(Equip_part.BELT);
		temp.addPart(Equip_part.SHOES);
		...
		//진하메타
		temp = new Card("진 : 하이퍼 메카 타우 보주", rarity);
		...
		//노블보주
		temp = new Card("노블스카이 홍옥 보주", rarity);
		...
		temp = new Card("노블스카이 청옥 보주", rarity);
		temp.addPart(Equip_part.AIDEQUIPMENT);
		...
		//이름뭐더라
		temp = new Card("황룡의 백옥 보주", rarity);
