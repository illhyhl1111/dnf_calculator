...
public class SetOptionInfo {
	public static void getInfo(LinkedList<SetOption> setOptionList)
	{
		...
		/////천
		//닼고
		temp = new SetOption(SetName.DARKGOTH, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//드로퍼
		temp = new SetOption(SetName.DROPPER, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//게슈펜슈트
		temp = new SetOption(SetName.GESPENST, 3, CalculatorVersion.VER_1_0_b);
		temp.vStat.addStatList("모공증", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GESPENST, 5, CalculatorVersion.VER_1_0_b);
		temp.vStat.addStatList("모공증", 35);
		setOptionList.add(temp);

		/////가죽
		//카멜
		temp = new SetOption(SetName.CHAMELEON, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//암살
		temp = new SetOption(SetName.ASSASSIN, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		temp = new SetOption(SetName.BLACKFORMAL, 5, CalculatorVersion.VER_1_0_a);
		...
		/////경갑
		//섭마
		temp = new SetOption(SetName.SUBMARINE, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("화속", 50);
		temp.vStat.addStatList("화추뎀", 8);
		setOptionList.add(temp);
		//자수
		temp = new SetOption(SetName.NATURALGARDIAN, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//황갑
		temp = new SetOption(SetName.GOLDENARMOR, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("모속강", 25);
		temp.vStat.addStatList("추뎀", 15);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GOLDENARMOR, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("크증뎀", 35);
		setOptionList.add(temp);
		//초대륙
		temp = new SetOption(SetName.SUPERCONTINENT, 3, CalculatorVersion.VER_1_0_b);
		temp.vStat.addStatList("추뎀", 22);
		setOptionList.add(temp);
		temp = new SetOption(SetName.SUPERCONTINENT, 5, CalculatorVersion.VER_1_0_b);
		temp.vStat.addStatList("모공증", 35);
		setOptionList.add(temp);
		
		/////중갑
		//미닼
		temp = new SetOption(SetName.DARKHOLE, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("추뎀", 30);
		temp.vStat.addStatList("추뎀", 20, false, true);
		setOptionList.add(temp);
		//거미
		temp = new SetOption(SetName.SPIDERQUEEN, 4, CalculatorVersion.VER_1_0_a);
		...
		temp = new SetOption(SetName.SPIDERQUEEN, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//고대전쟁
		temp = new SetOption(SetName.ANCIENTWAR, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addSkillRange(50, 50, 3, false);
		temp.vStat.addStatList("증뎀", 25);
		setOptionList.add(temp);
		temp = new SetOption(SetName.ANCIENTWAR, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addSkillRange(85, 85, 2, false);
		temp.vStat.addStatList("크증뎀", 35);
		temp.explanation.add("ㅈ년ㅈ쟁");
		setOptionList.add(temp);
		//나가라자
		temp = new SetOption(SetName.NAGARAJA, 3, CalculatorVersion.VER_1_0_b);
		...
		setOptionList.add(temp);
		//마소
		temp = new SetOption(SetName.MAELSTORM, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//풀플
		temp = new SetOption(SetName.FULLPLATE, 5, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//센츄리온
		temp = new SetOption(SetName.CENTURYONHERO, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", 100);
		temp.vStat.addStatList("지능", 100);
		temp.vStat.addStatList("추뎀", 25);
		setOptionList.add(temp);
		temp = new SetOption(SetName.CENTURYONHERO, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", 200);
		temp.vStat.addStatList("지능", 200);
		temp.vStat.addStatList("증뎀", 55);
		setOptionList.add(temp);
		//칠죄종
		temp = new SetOption(SetName.SEVENSINS, 3, CalculatorVersion.VER_1_0_b);
		temp.vStat.addStatList("추크증", 22);
		temp.vStat.addSkill_damage("영광의 축복", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.SEVENSINS, 5, CalculatorVersion.VER_1_0_b);
		...
		/////////////악세서리
		//슈스
		temp = new SetOption(SetName.SUPERSTAR, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("추뎀", 15);
		temp.dStat.addStatList("추뎀", 10, false, true);
		setOptionList.add(temp);
		//얼공
		temp = new SetOption(SetName.ICEQUEEN, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("수속강", 50);
		temp.vStat.addStatList("추뎀", 18);
		setOptionList.add(temp);
		//정마
		temp = new SetOption(SetName.REFINEDSTONE, 3, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//하늘의 여행자
		temp = new SetOption(SetName.SKYTRAVELER, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("추뎀", 30);
		setOptionList.add(temp);
		//황홀경
		temp = new SetOption(SetName.ECSTATICSENCE, 3, CalculatorVersion.VER_1_0_a);
		...
		//////////////레전더리
		///////결장
		temp = new SetOption(SetName.REAL_PROFIGHTER_ACCESSORY, 3, CalculatorVersion.VER_1_0_a);
		temp.dStat.addStatList("크증뎀", 15, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_SPECIALEQUIP, 2, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("독공", 165);
		temp.vStat.addStatList("모속강", 18);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_FABRIC, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_HARMOR, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_LEATHER, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_MAIL, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.REAL_PROFIGHTER_PLATE, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 10);
		temp.vStat.addStatList("마크", 10);
		temp.vStat.addStatList("모속강", 12);
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.GODOFFIGHT, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("물크", 3);
		temp.vStat.addStatList("마크", 3);
		temp.vStat.addStatList("크증뎀", 15);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GODOFFIGHT, 5, CalculatorVersion.VER_1_0_a);
		temp.dStat.addStatList("힘뻥", 5, false, true);
		temp.dStat.addStatList("지능뻥", 5, false, true);
		temp.vStat.addStatList("증뎀", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GODOFFIGHT, 6, CalculatorVersion.VER_1_0_a);
		...
		temp.dStat.addStatList("지능뻥", 5);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GREATGLORY, 6, CalculatorVersion.VER_1_0_a);
		temp.dStat.addStatList("힘뻥", 3);
		temp.dStat.addStatList("지능뻥", 3);
		setOptionList.add(temp);
		//비탄
		temp = new SetOption(SetName.DEVASTEDGRIEF, 3, CalculatorVersion.VER_1_0_a);
		temp.dStat.addStatList("증뎀", 20, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.DEVASTEDGRIEF, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("모속강", 15);
		temp.explanation.add("증뎀옵션은 3셋옵션을 키세여");
		setOptionList.add(temp);
		temp = new SetOption(SetName.DEVASTEDGRIEF, 6, CalculatorVersion.VER_1_0_a);
		temp.explanation.add("슈아쳐가 됩니다");
		setOptionList.add(temp);
		//그라시아
		temp = new SetOption(SetName.GRACIA, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", 50);
		temp.vStat.addStatList("힘", 50);
		temp.vStat.addStatList("명속강", 10);
		temp.dStat.addStatList(Element_type.LIGHT, 0, true, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GRACIA, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("명속강", 12);
		setOptionList.add(temp);
		temp = new SetOption(SetName.GRACIA, 6, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("명추뎀", 6);
		setOptionList.add(temp);
		//비명
		temp = new SetOption(SetName.BURIEDSCREAM, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("모속강", 10);
		temp.dStat.addStatList("%물방깍_템", 10, false, true);
		temp.dStat.addStatList("%마방깍_템", 10, false, true);
		setOptionList.add(temp);
		temp = new SetOption(SetName.BURIEDSCREAM, 5, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("모속강", 20);
		setOptionList.add(temp);
		temp = new SetOption(SetName.BURIEDSCREAM, 6, CalculatorVersion.VER_1_0_a);
		...
		setOptionList.add(temp);
		//길던
		temp = new SetOption(SetName.GUILDACCESSORY_FIRE, 3, CalculatorVersion.VER_1_0_a);
		...
		temp = new SetOption(SetName.RAREAVATAR, 5, CalculatorVersion.VER_1_0_a);
		temp.explanation.add("데미지 증가 효과 없음");
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.RAREAVATAR, 8, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", new StatusInfo(20));
		temp.vStat.addStatList("지능", new StatusInfo(20));
		setOptionList.add(temp);
		
		//상압
		temp = new SetOption(SetName.AVATAR, 3, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", new StatusInfo(10));
		temp.vStat.addStatList("지능", new StatusInfo(10));
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.AVATAR, 5, CalculatorVersion.VER_1_0_a);
		temp.explanation.add("데미지 증가 효과 없음");
		setOptionList.add(temp);
		
		temp = new SetOption(SetName.AVATAR, 8, CalculatorVersion.VER_1_0_a);
		temp.vStat.addStatList("힘", new StatusInfo(10));
		temp.vStat.addStatList("지능", new StatusInfo(10));
		setOptionList.add(temp);
	}
