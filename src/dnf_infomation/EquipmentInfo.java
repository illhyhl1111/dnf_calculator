	...
	public static Object[] weaponInfo()
	{
		...
		*/
		...
		Object[] data = new Object[] {
				...
				"화속강 24 가변", "스킬 록 온 서포트 3", "설명 록 온 서포트 공격시 35% 화속성 추가 데미지", "설명 평타 공격 시 7% 화속성 추가 데미지", "설명 구현상의 문제로 해당 수치의 스증뎀으로 적용(데미지는 정상적으로 계산됨)", null, 	//TODO 닐스구현
				...
				"물공 1267 가변", "마공 898 가변", "독공 648 가변", "힘 107 가변", "물크 2", 
				"ㄷ 스증뎀 35", "ㄷ 스증뎀 20 선택", enableElement, "설명 자신의 가장 높은 속성강화 수치의 속성을 무기에 부여한다.", null,
				"쥬빌런스 혼", "", "", "", "", 90, false, CalculatorVersion.VER_1_0_d,
				"물공 1337 가변", "마공 946 가변", "독공 686 가변", "힘 112 가변", "물크 2", 
				"추뎀 25", "추크증 30", "스킬 퀘이사 익스플로젼 % 10", "스킬 일기당천 % 10", "스킬 체페슈 % 10", "스킬 블러드 스트림 % 10", null,
				...
				"마스터 오브 체이서", "", "", "", "", 85, "", CalculatorVersion.VER_1_0_d, 
				"물공 1140 가변", "마공 950 가변", "독공 648 가변", "힘 72 가변", "지능 72 가변", 
				"스킬 오토 체이서 2", "스킬 체이서 에볼루션 1", "스킬 윈드니스 2", "스킬 휘몰아치는 질풍의 봉 마스터리 1",
				"설명 체이서 생성 시 왕체이서 생성, 사출 수 1 증가, 체이서 공격력 30% 감소, 체이서 에볼루션 다단히트 수 3 증가(미구현)",
