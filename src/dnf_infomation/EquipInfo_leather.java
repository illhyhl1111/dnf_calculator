...
public class EquipInfo_leather {
	public static void getInfo(HashSet<Equipment> equipList)
	{
		...
		/////카멜레온
		setName=SetName.CHAMELEON;
		level=80;
		//카멜상의
		temp = new Equipment("교활한 카멜레온 가죽 상의", null, Item_rarity.EPIC, Equip_part.ROBE, type, setName, level);
		...
		//카멜하의
		temp = new Equipment("민첩한 카멜레온 가죽 하의", null, Item_rarity.EPIC, Equip_part.TROUSER, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(41), true);
		temp.vStat.addStatList("지능", new StatusInfo(41), true);
		...
		//카멜숄더
		temp = new Equipment("날렵한 카멜레온 가죽 숄더", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, setName, level);
		...
		//카멜벨트
		temp = new Equipment("은밀한 카멜레온 가죽 벨트", null, Item_rarity.EPIC, Equip_part.BELT, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(24), true);
		temp.vStat.addStatList("지능", new StatusInfo(24), true);
		equipList.add(temp);
		
		//카멜신발
		temp = new Equipment("재빠른 카멜레온 가죽 신발", null, Item_rarity.EPIC, Equip_part.SHOES, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(24), true);
		temp.vStat.addStatList("지능", new StatusInfo(24), true);
		equipList.add(temp);
		...
		/////택틱, 웨슬리
		setName=SetName.TACTICAL;
		level=85;
		//택틱상의, 택상의
		temp = new Equipment("택틱컬 커맨더 상의", null, Item_rarity.EPIC, Equip_part.ROBE, type, setName, level);
		...
		//택틱하의, 택하의
		temp = new Equipment("택틱컬 리더 하의", null, Item_rarity.EPIC, Equip_part.TROUSER, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(76), true);
		temp.vStat.addStatList("지능", new StatusInfo(76), true);
		...
		//택틱어깨, 택어깨
		temp = new Equipment("택틱컬 리더 숄더", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(67), true);
		temp.vStat.addStatList("지능", new StatusInfo(67), true);
		equipList.add(temp);
		
		//택틱벨트, 택벨
		temp = new Equipment("택틱컬 로드 벨트", null, Item_rarity.EPIC, Equip_part.BELT, type, setName, level);
		...
		//택틱신발, 택신
		temp = new Equipment("택틱컬 치프 신발", null, Item_rarity.EPIC, Equip_part.SHOES, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(58), true);
		temp.vStat.addStatList("지능", new StatusInfo(58), true);
		...
		/////암살자
		setName=SetName.ASSASSIN;
		//암살상의, 밤그상의
		temp = new Equipment("밤의 그림자 상의", null, Item_rarity.EPIC, Equip_part.ROBE, type, setName, level);
		...
		//암살하의, 붉송하의
		temp = new Equipment("붉은 송곳니 하의", null, Item_rarity.EPIC, Equip_part.TROUSER, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(92), true);
		temp.vStat.addStatList("지능", new StatusInfo(92), true);
		...
		//암살어깨
		temp = new Equipment("어둠의 칼날 어꺠", null, Item_rarity.EPIC, Equip_part.SHOULDER, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(67), true);
		temp.vStat.addStatList("지능", new StatusInfo(67), true);
		...
		//암살벨트
		temp = new Equipment("죽음의 장막 벨트", null, Item_rarity.EPIC, Equip_part.BELT, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(58), true);
		temp.vStat.addStatList("지능", new StatusInfo(58), true);
		...
		//암살신발, 황천신
		temp = new Equipment("황천의 바람 신발", null, Item_rarity.EPIC, Equip_part.SHOES, type, setName, level);
		temp.vStat.addStatList("힘", new StatusInfo(58), true);
		temp.vStat.addStatList("지능", new StatusInfo(58), true);
