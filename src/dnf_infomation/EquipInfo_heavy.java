...
public class EquipInfo_heavy {
	...
	public static void getInfo(HashSet<Equipment> equipList)
	{
		...
		//미닼상의
		temp = new Equipment("미지의 다크홀 상의", image+"미닼상의.png", rarity, Equip_part.ROBE, Equip_type.HEAVY, setName); 
		...
		//미닼하의
		temp = new Equipment("미지의 다크홀 하의", image+"미닼하의.png", rarity, Equip_part.TROUSER, Equip_type.HEAVY, setName); 
		temp.vStat.addStatList("힘", new StatusInfo(44), true);
		temp.vStat.addStatList("물크", new DoubleStatusInfo(4));
		temp.vStat.addStatList("지능", new StatusInfo(32), true);
		temp.vStat.addStatList("마크", new DoubleStatusInfo(4));
		...
		//미닼어깨
		temp = new Equipment("미지의 다크홀 어깨", image+"미닼어깨.png", rarity, Equip_part.SHOULDER, Equip_type.HEAVY, setName);
		...
		//미닼벨트
		temp = new Equipment("미지의 다크홀 벨트", image+"미닼벨트.png", rarity, Equip_part.BELT, Equip_type.HEAVY, setName);
		...
		//미닼신발
		temp = new Equipment("미지의 다크홀 신발", image+"미닼신발.png", rarity, Equip_part.SHOES, Equip_type.HEAVY, setName);
		...
		//거미상의
		temp = new Equipment("타란튤라 상의", image+"거미상의.png", rarity, Equip_part.ROBE, Equip_type.HEAVY, SetName.SPIDERQUEEN); 
		...
		//거미하의
		temp = new Equipment("킹바분 하의", image+"거미하의.png", rarity, Equip_part.TROUSER, Equip_type.HEAVY, SetName.SPIDERQUEEN);
		temp.vStat.addStatList("힘", new StatusInfo(200), true);
		temp.vStat.addStatList("지능", new StatusInfo(188), true);
		temp.dStat.addStatList("고정물방깍", new StatusInfo(12000), false, true);
		temp.dStat.addStatList("고정마방깍", new StatusInfo(12000), false, true);
		...
		//거미어깨
		temp = new Equipment("골리앗 버드이터 어깨", image+"거미어깨.png", rarity, Equip_part.SHOULDER, Equip_type.HEAVY, SetName.SPIDERQUEEN);
		...
		//거미벨트
		temp = new Equipment("로즈헤어 벨트", image+"거미벨트.png", rarity, Equip_part.BELT, Equip_type.HEAVY, SetName.SPIDERQUEEN);
		...
		//거미신발
		temp = new Equipment("인디언 오너멘탈 신발", image+"거미신발.png", rarity, Equip_part.SHOES, Equip_type.HEAVY, SetName.SPIDERQUEEN);
		temp.vStat.addStatList("힘", new StatusInfo(138), true);
		temp.vStat.addStatList("지능", new StatusInfo(130), true);
		temp.dStat.addStatList("고정물방깍", new StatusInfo(12000), false, true);
		temp.dStat.addStatList("고정마방깍", new StatusInfo(12000), false, true);
		...
		//금계상의, 피맹상의
		temp = new Equipment("피의 맹약 상의", image+"금계상의.png", rarity, Equip_part.ROBE, Equip_type.HEAVY, setName); 
		...
		//금계하의, 서약하의
		temp = new Equipment("마나의 서약 하의", image+"금계하의.png", rarity, Equip_part.TROUSER, Equip_type.HEAVY, setName);
		...
		//금계어깨, 마계숄
		temp = new Equipment("마력의 계약 솔더", image+"금계어깨.png", rarity, Equip_part.SHOULDER, Equip_type.HEAVY, setName);
		...
		//금계벨트, 협약벨트
		temp = new Equipment("체력의 협약 벨트", image+"금계벨트.png", rarity, Equip_part.BELT, Equip_type.HEAVY, setName);
		...
		//금계신발, 피조부츠
		temp = new Equipment("피의 조약 부츠", image+"금계신발.png", rarity, Equip_part.SHOES, Equip_type.HEAVY, setName);
		temp.vStat.addStatList("힘", new StatusInfo(28), true);
		temp.vStat.addStatList("지능", new StatusInfo(20), true);
