		...
		*/
		...
		Object[] data = new Object[] {
				...
				*/
				...
				"위대한 영광의 중갑 상의", "", Equip_part.ROBE, "", SetName.GREATGLORY, 85, false, CalculatorVersion.VER_1_1_a,
				"힘 199 가변", "지능 187 가변", "물크 5", "마크 5", null,
				"위대한 영광의 중갑 하의", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 199 가변", "지능 187 가변", "물크 5", "마크 5", null,
				"위대한 영광의 중갑 어깨", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 190 가변", "지능 180 가변", "물크 5", "마크 5", null,
				"위대한 영광의 중갑 허리", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 182 가변", "지능 174 가변", "물크 5", "마크 5", null,
				"위대한 영광의 중갑 신발", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 105 가변", "지능 97 가변", "ㄷ 모속강 10 선택", null,
				
				"붉게 물든 서녘의 중갑 상의", "", Equip_part.ROBE, "", SetName.ROMANTICE, 85, false, CalculatorVersion.VER_1_1_a,
				"힘 45 가변", "지능 33 가변", "물공 50 가변", "마공 50 가변", "독공 75 가변", "ㄷ 물크 10 선택", "ㄷ 마크 10 선택", "설명 물마크 증가는 상, 하의 중 하나만 적용", null,
				"붉게 물든 서녘의 중갑 하의", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 45 가변", "지능 33 가변", "물공 50 가변", "마공 50 가변", "독공 75 가변", "ㄷ 물크 10 선택", "ㄷ 마크 10 선택", "설명 물마크 증가는 상, 하의 중 하나만 적용", null,
				"붉게 물든 서녘의 중갑 어깨", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 36 가변", "지능 26 가변", "물공 50 가변", "마공 50 가변", "독공 75 가변", null,
				"붉게 물든 서녘의 중갑 허리", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 28 가변", "지능 20 가변", "물공 50 가변", "마공 50 가변", "독공 75 가변", null,
				"붉게 물든 서녘의 중갑 신발", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_a,
				"힘 28 가변", "지능 20 가변", "물공 50 가변", "마공 50 가변", "독공 75 가변", null,
	...
	public static Object[] weaponInfo()
	{
		...
		fStat[6] = new FunctionStat(){
			...
			public StatusList function(Characters character, Monster monster, Object item) {
				...
				switch(type){
				case FIRE:
					statList.addStatList("화추뎀", 18);
					break;
				case WATER:
					statList.addStatList("수추뎀", 18);
					break;
				case LIGHT:
					statList.addStatList("명추뎀", 18);
					break;
				case DARKNESS:
					statList.addStatList("암추뎀", 18);
					break;
				default:
					statList.addStatList("화추뎀", 18);
					break;
		...
		*/
		...
		Object[] data = new Object[] {
				...
				"래쿤 배큠", "", "", "", "", "", "", CalculatorVersion.VER_1_0_d,
				"물공 1056 가변", "마공 1162 가변", "독공 648 가변", "지능 72 가변", 
				"모속강 18 가변", "스킬 15-20 3", "설명 크리에이터 1-85레벨 스킬 +1(미구현)", "스킬 퓨전 크레프트 % 30", "스킬 괴리 : 형용할 수 없는 공포 % 30", "추뎀 12", null,
				...
				"물크 7", "마크 7", "추뎀 16", null,
				"울부짖는 타우의 갈기털", "", "", "", "", "", "", CalculatorVersion.VER_1_0_f,
				"물공 1002 가변", "마공 1102 가변", "독공 607 가변", "지능 68 가변",
				"ㄷ 추뎀 15 선택", "설명 근접 무기 공격 시 데미지 20% 증가(미구현)", "설명 화염, 냉기, 방해, 수호, 바람 게이지 25% 증가(미구현)", null,
				...
				"디스트럭션", "", "", "", "", 85, "", CalculatorVersion.VER_1_0_f,
				"물공 1267 가변", "마공 898 가변", "독공 648 가변", "힘 72 가변", 
				"ㄷ 힘 125 가변", "ㄷ %물방깍_템 50 가변", "설명 챔피언 몬스터에게는 1/3, 보스 및 헬몹에게는 1/6의 효과 적용", "설명 안톤 레이드, 각성안톤 던전에서는 적용되지 않습니다", null,
