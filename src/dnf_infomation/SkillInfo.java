...
public class SkillInfo {
	...
	public static Object[] skillInfo_fighter()
	{
		Object[] data = new Object[] {
				...
				"머슬 시프트", Skill_type.BUF_ACTIVE, "", 30, 15, 5, 5, CalculatorVersion.VER_1_2_b,
				"5", "증뎀버프 20", null,
				...
				"원인치 강화", "원인치", "", 65, 7, 5, 10, CalculatorVersion.VER_1_2_b, null,
				...
				"3", "스킬 라이징 너클 % 5.6", "+", "스킬 라이징 너클 % 14.4", "+", "스킬 라이징 너클 % 23.2", "+", "스킬 라이징 너클 % 32", "+", "스킬 라이징 너클 % 40.8", null,
