...
public class SkillInfo_gunner {
	...
	public static void getInfo(HashSet<Skill> skillList, Object[] data) throws ParsingException
	{
		...
		while(i<data.length)
		{
			...
			if(!isTPSkill && type!=Skill_type.PASSIVE){
				//속성
				temp = data[i++];
			...
			else if(jobDefined) skill = new Skill(name, type, job, firstLevel, maxLevel, masterLevel, interval, element);
	...
	public static Object[] skillInfo()
	{
