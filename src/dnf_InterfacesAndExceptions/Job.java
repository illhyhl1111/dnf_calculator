...
public enum Job implements java.io.Serializable
{
	...
	WEAPONMASTER(Character_type.SWORDMAN_M, "검신"), BUSERKER(Character_type.SWORDMAN_M, "블러드 이블", "구현 예정"),
	...
	DIMENSIONWALKER(Character_type.MAGE_M, "어센션"), CREATOR(Character_type.MAGE_F, "크리에이터", "구현 예정"),
	DARKKNIGHT(Character_type.SWORDMAN_M, "다크나이트"),
	VANGUARD(Character_type.DEMONICLANCER, "워로드", "바칼) 찔례"), DUALIST(Character_type.DEMONICLANCER, "듀란달"),
	ROUGE(Character_type.THIEF, "알키오네", "구현 예정"), KUNOICH(Character_type.THIEF, "시라누이"),
	SHADOWDANCER(Character_type.THIEF, "그림리퍼", "구현 예정"), NECROMENCER(Character_type.THIEF, "타나토스"),
