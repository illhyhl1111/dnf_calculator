	...
	public static Object[] equipmentInfo()
	{
		...
		*/
		...
		Object[] data = new Object[] {
				...
				"레이 디크리즈 숄더", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"지능 85 가변", "명속 12 가변", "ㄷ 명속깍 44 선택", null,
				"다크니스 로우 새쉬", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"지능 75 가변", "암속 12 가변", "ㄷ 암속깍 44 선택", null,
				"페이스 다운 슈즈", "", "--", "", "", "", "",
				"지능 75 가변", "모속 30", null,
				/////단일
				...
				"뉴타입 어태커 하의", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 51 가변", "지능 34 가변", "크증뎀 15", "ㄷ 크증뎀 20 선택", null,
				"디펜스 리시버 보호구", "", "--", "", "", "", "",
				...
				/////황갑
				"눈부신 황금 갑주 상의", "", Equip_part.ROBE, "", SetName.GOLDENARMOR, 90, "", CalculatorVersion.VER_1_1_g,
				"힘 130 가변", "지능 112 가변", "모속강 22 가변", "추증뎀 5", null,
				"눈부신 황금 갑주 하의", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 130 가변", "지능 112 가변", "모속강 22 가변", "추크증 5", null,
				"눈부신 황금 갑주 어깨", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 120 가변", "지능 106 가변", "모속강 22 가변", "모공증 5", null,
				"눈부신 황금 갑주 허리", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 109 가변", "지능 98 가변", "모속강 22 가변", "ㄷ 물공뻥 5", "ㄷ 마공뻥 5", "ㄷ 독공뻥 5", null,
				"눈부신 황금 갑주 신발", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 109 가변", "지능 98 가변", "모속강 22 가변", "ㄷ 힘뻥 5", "ㄷ 지능뻥 5", null,
				/////초대륙
				...
				"힘 111 가변", "지능 111 가변", "스킬 스트라이킹 3", "스킬 스트라이킹 % 15", "ㄷ 적방무 15 선택", fStat[12], "설명 45레벨 스킬 공격력 12% 증가", "설명  ", "설명 오만함에 잠기기 시작한 자는", null,
				"폭식하는 입", "", "--", "", "", "", "", 
				"힘 111 가변", "지능 111 가변", "스킬 지혜의 축복 3", "스킬 지혜의 축복 % 15", "ㄷ 물공뻥 15 선택", "ㄷ 마공뻥 15 선택", "ㄷ 독공뻥 15 선택",
				...
				"질투를 말하는 혀", "", "--", "", "", "", "",
				"힘 92 가변", "지능 92 가변", "스킬 여명의 축복 3", "스킬 여명의 축복 % 20", "모공증 12", fStat[12], "설명 30레벨 스킬 공격력 15% 증가", "설명  ", "설명 모든 것을 질투하기 시작하고", null,
				"나태함을 가진 발", "", "--", "", "", "", "",
				"힘 92 가변", "지능 92 가변", "물크 25", "마크 25", fStat[12], "설명 25레벨 스킬 공격력 15% 증가", "설명  ", "설명 결국 모든 것을 잃을 지어니", null,
				...
				"레인보우 이어링", "", "", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 59 가변", "지능 59 가변", "물크 3", "마크 3", "모속강 12 가변", "힘 100 선택", "지능 100 선택", null,
				/////레전더리
				...
				"힘 128 가변", "지능 128 가변", "모속강 18 가변", "모공증 3", "설명 비탄항아리 : 슬퍼 말거라...", null,
				"큐빅 오브 식스테일", "", "", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"물크 6", "마크 6", "추증뎀 6", "추크증 6", null,
				"골드 볼텍스", "", "", "", "", "", "", CalculatorVersion.VER_1_1_g,
				"힘 62 가변", "지능 62 가변", "모속강 24 가변", "설명 속도 최강 볼텍스", null,
				...
				"힘 117 가변", "지능 117 가변", "물공 121 가변", "마공 121 가변", "독공 139 가변", null,
				...
				"바벨로니아의 상징", "", "", "", "", "", true, CalculatorVersion.VER_1_1_g,
				"힘 63 가변", "지능 63 가변", "모속강 18 가변", "ㄷ 모공증 18 선택", "설명 겜", null,
				...
				*/
				...
				"해신의 저주를 받은 심해의 기운", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_h,
				"힘 39 가변", "지능 39 가변", "수속강 18 가변", null, 
				"해신의 저주를 받은 심해석", "", "--", "", "", "", "", CalculatorVersion.VER_1_1_h,
				"힘 58 가변", "지능 58 가변", "수속강 18 가변", null, 
				//서녘
				...
				"목각인형 제조서 : X", "", "", "", "", "", "", CalculatorVersion.VER_1_1_g,
				...
				"설명 귀검사/나이트/격투가/도적/프리스트 45레벨 스킬 Lv+4", "설명 아이고 죽겠다", null,
				"돌격대장의 어택 맥시마이저", "", "", "", "", "", "",
				...
				"힘 62 가변", "지능 62 가변", "ㄷ 스증뎀 10 선택", null,
	...
	public static Object[] weaponInfo()
	{
		...
		*/
		...
		Object[] data = new Object[] {
				...
				"물공 1056 가변", "마공 1162 가변", "독공 648 가변", "지능 72 가변", 
				"모속강 18 가변", fStat[18], "설명 크리에이터 1-85레벨 스킬 +1", "설명 마법사 15-20레벨 스킬 +3", "스킬 퓨전 크레프트 % 30", "스킬 괴리 : 형용할 수 없는 공포 % 30", "추뎀 12", null,
				...
				"디스트럭션", "", "", "", "", 85, "", CalculatorVersion.VER_1_1_g,
				...
				"ㄷ 추뎀 15 선택", "스킬 진격의 황룡 % 15 선택", "설명 추뎀 조건 : 보스, 네임드, 챔피언 몹 공격시", "설명 황룡격 스증은 물딜에만 적용됩니다 마딜은 꺼주세요", null,
